...
def test(
    ...
    *, 
    ...
    file_name = f"0145_xinxi_test5_loc_res_meanerr_{mean_l2:.4f}.csv"
...
if __name__ == "__main__":
    ...
    test_dir = Path("data") / "data_for_train_test_v1" / "12.25-xinxi-resample-zscore-all-feature-5-v3" / "test5"
    ckpt_path = Path("checkpoints") / "mag_imu_eqnio" / "mag_imu_eqnio_best_20260319_0145_rmse_2d_0.762_xinxi_v3.pt"
    res_dir = Path("runs") / "loc_res" / "mag_imu_eqnio_different_phone_xinxi_2"
