...
CSV_PATHS = [
    ...
    ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_xinxi" / "1614_xinxi_test4_loc_res_meanerr_0.4872.csv",
    ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_xinxi" / "1549_xinxi_test1_loc_res_meanerr_0.7334.csv",
    ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_xinxi" / "1551_xinxi_test3_loc_res_meanerr_1.2220.csv",
    ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_xinxi" / "1614_xinxi_test3_loc_res_meanerr_3.8405.csv",
 
    # ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_xinxi_2" / "1432_xinxi_2_test7_loc_res_meanerr_0.5382.csv",
    # ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_xinxi_2" / "1549_xinxi_2_test8_loc_res_meanerr_0.8119.csv",
    # ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_xinxi_2" / "1551_xinxi_2_test7_loc_res_meanerr_1.1677.csv",
    # ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_xinxi_2" / "1614_xinxi_2_test7_loc_res_meanerr_3.8457.csv",
   
]


LABELS = ["EMI-Loc", "MS-TMTCN-Loc", "EMI-Mag", "PDR"]
OUTPUT_PATH = ROOT / "figures" / "loc_cdf_different_method_xinxi.svg"
...
def main():
    ...
    # x_max = 6
    plt.xticks(np.linspace(0, 40, num=5))
