...
CSV_PATHS = [
    ...
    ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_wenguan" / "2314_wenguan_test2_loc_res_meanerr_0.5483.csv",
    ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_wenguan" / "2128_wenguan_test2_loc_res_meanerr_0.8830.csv",
    ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_wenguan" / "1423_wenguan_test2_loc_res_meanerr_1.0237.csv",
    ROOT / "runs" / "loc_res" / "mag_imu_eqnio_different_method_wenguan" / "1620_wenguan_test2_loc_res_meanerr_3.5379.csv",
    
]

# LABELS = ["Proposed", "Wang(2024)", "HLSTM(2022)", "MAIL(2020)", "RNN"]
LABELS = ["EMI-Loc", "MS-TMTCN-Loc", "EMI-Mag", "PDR"]
OUTPUT_PATH = ROOT / "figures" / "loc_cdf_different_method_wenguan.svg"
